...
// };
    ...
    return (
        ...
        <div>
              ...
              <div>
                <label htmlFor="battingTeam">Select Batting Team:</label>
                <select id="battingTeam" value={battingTeam} onChange={handleBattingTeamChange}>
            ...
            {/* Render the rest of the component based on the selected batting team */}
            {battingTeam && (
            ...
            <div className="cricket-scoreboard">
                ...
                <div>
                    ...
                    <select value={batsman2} onChange={(e) => handleBatsmanChange(e, 1)}>
                        <option value="">Select Batsman</option>
                        {batsmen.map((player) => (
                            <option key={player} value={player}>{player}</option>
                        ))}
                    ...
                    <div className="buttons">
                        ...
                        <div className="button-group">
                            {[0, 1, 2, 3, 4, 5, 6].map((run, index) => (
                                <button key={index} onClick={() => updateScore(run)}>{run}</button>
                            ))}
                        </div>
                        ...
                        <div className="checkbox-group">
                            <div className="checkbox-container">
                                <select onChange={(e) => updateExtras1(e.target.value)}>
                            ...
                            <div className="checkbox-container">
                                <select onChange={(e) => updateExtras2(e.target.checked, e.target.value)}>
                            ...
                            <div className="checkbox-container">
                                <select onChange={(e) => updateExtras3(e.target.value)}>
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
